export const kurumsalData = {
  ...
  mutevelliHeyeti: [
    "2017 yılında, Fenerbahçe’ye gönül vermiş iş insanlarıyla birlikte aynı masa etrafında buluşarak kurduğumuz Fenerbahçeli İş Adamları Vakfı’nın, kuruluş amaçlarından ve değerlerinden sapmadan; misyonu ve vizyonu doğrultusunda kararlılıkla yoluna devam ettiğini görmek benim için büyük bir mutluluk ve gurur kaynağıdır.",
    "Vakfımızı kurarken temel düşüncemiz; Fenerbahçelilikten aldığımız birlik, dayanışma ve aidiyet duygusunu toplumsal faydaya dönüştürmek, imkânlarımızı ihtiyaç sahipleriyle paylaşmak ve ülkemize kalıcı değerler bırakacak projeler hayata geçirmekti.",
    "Bugüne kadar bu anlayışla birçok sosyal sorumluluk projesinin içerisinde yer aldık. İstanbul Çekmeköy’de hayata geçirdiğimiz 10.000 fidanlık Hatıra Ormanımız, gelecek nesillere bırakmak istediğimiz kalıcı değerlerin en güzel örneklerinden biri oldu. Bunun yanında birçok ailemize doğrudan destek sağladık; toplumsal fayda üreten dernek ve vakıflarla iş birlikleri gerçekleştirerek farklı sosyal sorumluluk çalışmalarına katkıda bulunduk.",
    "Ancak vakfımızın üzerinde en büyük hassasiyetle durduğu alanlardan biri her zaman eğitim ve gençlerimiz oldu.",
    "Uzun yıllardır üniversite eğitimi gören, desteğe ihtiyaç duyan kız öğrencilerimize burs sağlıyoruz. Bursiyerlerimizin seçiminde özellikle anne veya babasından birini kaybetmiş, devlet korumasında yetişmiş ve tüm zorluklara rağmen üniversite eğitimine devam ederek kendi geleceğini kurmak için mücadele eden gençlerimize öncelik veriyoruz.",
    "Bizim için burs vermek yalnızca maddi bir destekten ibaret değildir. Asıl hedefimiz, gençlerimizin hayatlarına gerçek anlamda dokunabilmektir. Eğitim süreçlerinin yanında olmak, kariyer planlamalarına katkı sağlamak, iş hayatına hazırlanırken tecrübelerimizi paylaşmak ve mümkün olduğunca geleceklerini şekillendirdikleri bu önemli dönemde yanlarında durmak istiyoruz.",
    "Bu süreci büyük bir hassasiyetle takip eden, bursiyerlerimizi yakından tanıyan ve gelişimlerini düzenli olarak değerlendiren çok kıymetli bir çalışma grubumuz bulunuyor. Onların özverili çalışmaları sayesinde burs programımızı yalnızca bir maddi yardım sistemi olarak değil, gençlerimizin geleceğine eşlik eden uzun soluklu bir dayanışma modeli olarak görüyoruz.",
    "Vakfımızın kuruluşundan bugüne kadar gerçekleştirdiğimiz bütün çalışmaların arkasında bağışçılarımızın, üyelerimizin, gönüllülerimizin ve bize güvenerek destek veren dostlarımızın çok büyük katkısı bulunmaktadır. Bu vesileyle vakfımıza katkı sağlayan, bir öğrencimizin eğitimine, bir ailenin hayatına veya gerçekleştirdiğimiz herhangi bir sosyal sorumluluk projesine destek olan herkese gönülden teşekkür ediyorum.",
    "Fenerbahçeli İş Adamları Vakfı’nın Fenerbahçe ile olan bağı ise yalnızca isminden ve gönül birlikteliğinden ibaret değildir. Vakıf senedimizde yer alan hüküm gereğince, vakfımızın herhangi bir nedenle sona ermesi halinde sahip olduğu mal varlığının Fenerbahçe Spor Kulübü’ne devredilmesi öngörülmüştür. Bu hüküm, vakfımızın Fenerbahçe’ye olan aidiyetinin ve bağlılığının kuruluşundan itibaren taşıdığı anlayışın en önemli göstergelerinden biridir.",
    "2017 yılında büyük bir inançla çıktığımız bu yolda bugün geldiğimiz noktayı çok değerli buluyor; ancak yapacak daha çok işimiz, ulaşacak daha çok gencimiz ve dokunacak daha çok hayatımız olduğuna inanıyorum.",
    "Fenerbahçeli İş Adamları Vakfı, kuruluş gayesine bağlı kalarak; eğitime, gençlerimize, ihtiyaç sahiplerine ve topluma değer katmak için tüm gücüyle çalışmaya devam edecektir.",
    "Bu yolculukta bizimle birlikte olan herkese bir kez daha teşekkür ediyor, sevgi ve saygılarımı sunuyorum."
  ],
  degerlerimiz: [
    {
      baslik: "Dayanışma",
      aciklama: "Birlikte güçlenmenin ve paylaşmanın toplumsal dönüşüm yarattığına inanırız."
    },
    {
      baslik: "Fırsat Eşitliği",
      aciklama: "Her gencin eşit imkanlarla geleceğe hazırlanma hakkını savunuruz."
    },
    {
      baslik: "Güven",
      aciklama: "Tüm çalışmalarımızı şeffaflık, samimiyet ve sorumluluk anlayışıyla yürütürüz."
    },
    {
      baslik: "Sürdürülebilir Destek",
      aciklama: "Gençlerin eğitim yolculuğunda kalıcı fayda oluşturmayı hedefleriz."
    },
    {
      baslik: "Umut",
